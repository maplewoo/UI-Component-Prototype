...
export function JumpPaginationStyles() {
  return (
    <style>{`
      ...
      .ijp-wrap .ant-pagination-item,.ijp-wrap .ant-pagination-prev .ant-pagination-item-link,.ijp-wrap .ant-pagination-next .ant-pagination-item-link{height:var(--h-ctrl, 28px);line-height:26px;border-radius:var(--r-ctrl, 6px);}
      ...
      .ijp-jump{position:absolute;right:0;top:0;display:inline-flex;align-items:center;gap:6px;height:var(--h-ctrl, 28px);line-height:28px;font-size:var(--f-body, 14px);font-weight:var(--fw-regular, 400);color:var(--t2, rgba(0,0,0,0.65));}
      .ijp-jump .ijp-input{width:48px;height:var(--h-ctrl, 28px);padding:0 6px;text-align:center;font-variant-numeric:tabular-nums;}
    `}</style>
  );
}
...
function JumpPaginationDemo() {
  ...
  return (
    <div className="ijp-wrap" style={{ maxWidth: 720, background: '#fff', padding: 16, borderRadius: 'var(--r-card, 8px)' }}>
